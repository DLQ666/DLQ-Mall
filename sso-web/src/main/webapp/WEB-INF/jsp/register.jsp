            ...
            <div class="form" onselectstart="return false;">
                <div class="item" id="select-regName">
                    ...
                    <div class="fl item-ifo">
                        <div class="o-intelligent-regName">
                            <input type="text" id="regName" name="custname" class="text" tabindex="1" autoComplete="off"
                ...
                <div id="o-password">
                    <div class="item">
                        ...
                        <div class="fl item-ifo">
                            <input type="password" id="pwd" name="custpassword" class="text" tabindex="2"
					...
					<div class="item" id="dphone">
						...
						<div class="fl item-ifo">
							<input type="text" id="phone" maxlength="11" name="custcall"
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《奇酷商城用户注册协议》</a></label>
                        <span class="clr"></span>
