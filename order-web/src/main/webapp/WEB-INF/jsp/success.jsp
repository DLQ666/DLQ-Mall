...
<body id="mainframe">
	...
	<div class="w" id="headers">
		<div id="logo">
			<a href="/"><img alt="奇酷商城" src="/images/zuizhongban.png"></a>
		</div>
			...
			<div class="mc" id="success_detail">
				<ul class="list-order">
					<li class="li-st">
						...
						<div class="fore2">
							货到付款：<strong class="ftx-01">${payment *100}元</strong>
						</div>
						<div class="fore3">奇酷快递 &nbsp; 送货时间: 预计 ${date } 送达&nbsp;</div>
					</li>
				</ul>
				<!-- 在线支付按钮  -->
				<div id="bookDiv"></div>
